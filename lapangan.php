...
include "koneksi.php";
session_start();
$result = mysqli_query($conn, "SELECT * FROM lapangan WHERE status='kosong'");
?>
        ...
        <div class="col-lg-12">
          <div class="card mt-4">
            <div class="card-header">
              <h3 class="card-title text-center">Info Lapangan 1 yang Kosong</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <tbody>
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="boking.php?id=<?php echo $data['id_lapangan']; ?>" class="btn btn-primary">Booking</a>
                      </td>
                    </tr>
                  <?php
                  }
